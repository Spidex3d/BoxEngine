...
bool LoopCut::Use(MeshEditing& mesh, std::size_t edgeIndex, float amount)
{
    if (edgeIndex >= mesh.GetEdgeCount())
    {
        BOX_LOG_ERROR("LoopCut: Invalid edge index");
    ...
    {
        BOX_LOG_ERROR(
            "LoopCut: selected edge is not part of a quad"
        );
